...
/**
 * Criteria class for the {@link com.myriadquest.kreiscms.domain.SslcResult} entity. This class is used
 * in {@link com.myriadquest.kreiscms.web.rest.SslcResultResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sslc-results?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class SslcResultCriteria implements Serializable, Criteria {
    ...
    public SslcResultCriteria() {
    }

    public SslcResultCriteria(SslcResultCriteria other) {
    ...
    @Override
    public SslcResultCriteria copy() {
        return new SslcResultCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SslcResultCriteria that = (SslcResultCriteria) o;
        return
