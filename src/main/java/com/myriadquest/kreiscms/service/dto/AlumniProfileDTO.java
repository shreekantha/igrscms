...
/**
 * A DTO for the {@link com.myriadquest.kreiscms.domain.AlumniProfile} entity.
 */
public class AlumniProfileDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlumniProfileDTO)) {
            return false;
        }

        return id != null && id.equals(((AlumniProfileDTO) o).id);
    }
