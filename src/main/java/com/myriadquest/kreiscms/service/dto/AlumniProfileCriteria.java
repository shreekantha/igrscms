...
/**
 * Criteria class for the {@link com.myriadquest.kreiscms.domain.AlumniProfile} entity. This class is used
 * in {@link com.myriadquest.kreiscms.web.rest.AlumniProfileResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /alumni-profiles?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class AlumniProfileCriteria implements Serializable, Criteria {
    ...
    public AlumniProfileCriteria() {
    }

    public AlumniProfileCriteria(AlumniProfileCriteria other) {
    ...
    @Override
    public AlumniProfileCriteria copy() {
        return new AlumniProfileCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlumniProfileCriteria that = (AlumniProfileCriteria) o;
        return
