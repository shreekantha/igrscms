...
export class InstituteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.instituteService
      ...
      .subscribe(
        (res: HttpResponse<IInstitute[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInInstitutes(): void {
    this.eventSubscriber = this.eventManager.subscribe('instituteListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IInstitute[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
