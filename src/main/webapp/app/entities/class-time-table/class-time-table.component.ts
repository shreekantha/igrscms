...
export class ClassTimeTableComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.classTimeTableService
      ...
      .subscribe(
        (res: HttpResponse<IClassTimeTable[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInClassTimeTables(): void {
    this.eventSubscriber = this.eventManager.subscribe('classTimeTableListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IClassTimeTable[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/class-time-table'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
