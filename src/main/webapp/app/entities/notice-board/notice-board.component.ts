...
export class NoticeBoardComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.noticeBoardService
      ...
      .subscribe(
        (res: HttpResponse<INoticeBoard[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInNoticeBoards(): void {
    this.eventSubscriber = this.eventManager.subscribe('noticeBoardListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: INoticeBoard[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
