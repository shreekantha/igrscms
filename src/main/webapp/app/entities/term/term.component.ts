...
export class TermComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.termService
      ...
      .subscribe(
        (res: HttpResponse<ITerm[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTerms(): void {
    this.eventSubscriber = this.eventManager.subscribe('termListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITerm[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
