...
export class DegreeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.degreeService
      ...
      .subscribe(
        (res: HttpResponse<IDegree[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDegrees(): void {
    this.eventSubscriber = this.eventManager.subscribe('degreeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDegree[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
