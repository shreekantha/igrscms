...
export class ContactDetailsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contactDetailsService
      ...
      .subscribe(
        (res: HttpResponse<IContactDetails[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInContactDetails(): void {
    this.eventSubscriber = this.eventManager.subscribe('contactDetailsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IContactDetails[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
