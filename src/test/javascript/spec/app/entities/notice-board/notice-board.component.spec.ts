...
import { NoticeBoardComponent } from 'app/entities/notice-board/notice-board.component';
...
describe('Component Tests', () => {
  describe('NoticeBoard Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NoticeBoardComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.noticeBoards && comp.noticeBoards[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
