...
import { VisionComponent } from 'app/entities/vision/vision.component';
import { VisionService } from 'app/entities/vision/vision.service';
import { Vision } from 'app/shared/model/vision.model';

describe('Component Tests', () => {
  describe('Vision Management Component', () => {
    let comp: VisionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VisionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.visions && comp.visions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
