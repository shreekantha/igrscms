...
import { TestimonialComponent } from 'app/entities/testimonial/testimonial.component';
...
describe('Component Tests', () => {
  describe('Testimonial Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.testimonials && comp.testimonials[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
