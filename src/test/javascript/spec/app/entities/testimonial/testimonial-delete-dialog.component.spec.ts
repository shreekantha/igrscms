...
import { TestimonialDeleteDialogComponent } from 'app/entities/testimonial/testimonial-delete-dialog.component';
  ...
  describe('Testimonial Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [TestimonialDeleteDialogComponent],
      })
